...
use App\Models\User;
use App\Models\ScheduleUnstructured;
use Illuminate\Auth\Access\HandlesAuthorization;

class ScheduleUnstructuredPolicy
{
    ...
    public function view(User $user, ScheduleUnstructured $su): bool
    {
    ...
    public function update(User $user, ScheduleUnstructured $su): bool
    {
        return $user->hasRole('ADMIN') || $user->hasPermissionTo('actualizar horario');
    }

    public function delete(User $user, ScheduleUnstructured $su): bool
    {
