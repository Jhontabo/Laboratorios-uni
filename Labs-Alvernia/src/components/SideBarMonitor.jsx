            ...
            >
                <div>
                    <h1 className="text-center text-2xl font-bold text-white mb-10">
                        Monitor<span className="text-primary text-4xl">.</span>
                    </h1>
                    ...
                    <ul>
                        ...
                        <li>
                            <Link
                                ...
                                className="flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-gray-700 transition-colors text-white"
                            >
                                <RiToolsLine className="text-white text-2xl" /> Equipos
                            </Link>
                        </li>
                        <li>
                            <Link
                        ...
                        <li>
                            <Link
                                ...
                                className="flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-gray-700 transition-colors text-white"
                            >
                                <RiUserLine className="text-white text-2xl" /> Usuarios
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                className="flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-gray-700 transition-colors text-white"
                            >
                                <RiFileListLine className="text-white text-2xl" /> Reportes
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link
                                ...
                                className="flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-gray-700 transition-colors text-white"
                            >
                                <RiToolsLine className="text-white text-2xl" /> Mantenimiento
                            </Link>
                        </li>
