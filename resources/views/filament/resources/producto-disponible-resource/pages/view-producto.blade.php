            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
                ...
                <div class="md:col-span-1">
                    <div class="flex flex-col items-center space-y-4">
                        @if ($record->imagen)
                            <img src="{{ Storage::url($record->imagen) }}" alt="Imagen del producto"
                ...
                <div class="md:col-span-2 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <p class="text-gray-900 dark:text-white">{{ $record->descripcion ?? 'N/A' }}</p>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-gray-900 dark:text-white">
                                {{ number_format($record->costo_unitario, 2, ',', '.') }} COP</p>
                        </div>

                        <div class="space-y-1">
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Número de serie</p>
                            <p class="text-gray-900 dark:text-white font-mono">{{ $record->numero_serie ?? 'N/A' }}</p>
                        </div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <p class="text-gray-900 dark:text-white">{{ $record->laboratorio->ubicacion ?? 'N/A' }}
                                </p>
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-gray-900 dark:text-white">
                                    {{ $record->categoria->nombre_categoria ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
