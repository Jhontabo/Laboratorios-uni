...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // Insertar usuarios
        $usuarioJhonId = DB::table('usuarios')->insertGetId([
            'nombre' => 'Jhon',
            'apellido' => 'Tajumbina',
        ...
        $usuarioJonathanId = DB::table('usuarios')->insertGetId([
            'nombre' => 'Jonathan',
            'apellido' => 'Burbano',
        ...
        DB::table('productos')->insert([
            [
                ...
                'id_laboratorio' => $laboratorioAId,  // Asumimos que ya tenemos laboratorios creados
                'id_categorias' => $consumiblesId,  // Asociado a la categoría "Consumibles"
            ...
            [
                ...
                'id_laboratorio' => $laboratorioBId,  // Asociado a un laboratorio
                'id_categorias' => $noConsumiblesId,  // Asociado a la categoría "No consumibles"
